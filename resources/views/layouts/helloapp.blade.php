...
<head>
    ...
    <style>
        body { font-size:12pt; color:#999; margin:5px; }
        ...
        th {font-size:8pt; background-color:#999; color:#fff; padding:5px 10px;}
        td {font-size:8pt; border: solid 1px #aaa; color:#999; padding:5px 10px}
